...
* remove mandatory -- separator for passthrough args ([94660b0](https://github.com/gh-extensions/gh-claude/commit/94660b0926f6c53e46d47c5767524802a26d8df3))

## [0.25.0](https://github.com/gh-extensions/gh-claude/compare/v0.24.0...v0.25.0) (2026-03-19)


### Features

* move claude agent args before subcommand keyword ([#86](https://github.com/gh-extensions/gh-claude/issues/86)) ([25b1ec4](https://github.com/gh-extensions/gh-claude/commit/25b1ec48cc792a5e8c570a3e8478a157254dd69f))
...
* add --checkout option to gh ai issue develop ([#21](https://github.com/gh-extensions/gh-claude/issues/21)) ([bd53c16](https://github.com/gh-extensions/gh-claude/commit/bd53c16b088458db29e3da0943cf24a35649c4c1))
* add -d/--description flag to gh ai commit ([8e3eb2c](https://github.com/gh-extensions/gh-claude/commit/8e3eb2ce0f1d83af28f3dfd37edb74eb626a08ab)), closes [#17](https://github.com/gh-extensions/gh-claude/issues/17)
* add -d/--description flag to gh ai pr review ([e43aa2e](https://github.com/gh-extensions/gh-claude/commit/e43aa2e49819946e24c82e3f1746ae8f6fc9beee)), closes [#18](https://github.com/gh-extensions/gh-claude/issues/18)
* add agent option passthrough to chat commands ([364bc96](https://github.com/gh-extensions/gh-claude/commit/364bc96e0e9e75640fd350850b457d0f08042bc4))
* add chat commands for interactive agent sessions ([2d5c26b](https://github.com/gh-extensions/gh-claude/commit/2d5c26b0153b1b83879fff82ef51975f0750526e))
* add chat subcommands for issue, pr, and run ([2e51030](https://github.com/gh-extensions/gh-claude/commit/2e51030511883d06b95ffe28b7ee0dde862b9a9f))
* add configurable sessions directory via ai.session.dir and GH_SESSION_DIR ([fe4b4f6](https://github.com/gh-extensions/gh-claude/commit/fe4b4f62a7c27bd56b1c97e62be5960d4e3ce892))
* add envsubst as a required dependency ([894b415](https://github.com/gh-extensions/gh-claude/commit/894b415f1e874cca754c67eb9c4d506d3ca5be5b))
* add gh ai issue comment command ([eeb421b](https://github.com/gh-extensions/gh-claude/commit/eeb421b69047f37563b55ec63f11fd86ce5ee77a))
* add gh ai issue create command ([09a648e](https://github.com/gh-extensions/gh-claude/commit/09a648ebda8885c8b99d8c697daede442a796e6c))
* add gh ai issue develop command and improve CLI consistency ([345b612](https://github.com/gh-extensions/gh-claude/commit/345b61279c25be141015d3baf83ae319bf430baf)), closes [#9](https://github.com/gh-extensions/gh-claude/issues/9)
* add gh ai issue edit command for AI-assisted issue updates ([768d472](https://github.com/gh-extensions/gh-claude/commit/768d47240a73c7fc066ad0c9bc7cb4914d6ae276))
* add gh ai pr comment subcommand ([12a8067](https://github.com/gh-extensions/gh-claude/commit/12a8067380522e637e4c002a76f0762ddc7466e7))
* add gh ai pr edit command and optional description for pr create ([4b0cb15](https://github.com/gh-extensions/gh-claude/commit/4b0cb15814665e82021d35d4dbe846caafeeaa77))
* add gh ai pr explain command ([4c988a6](https://github.com/gh-extensions/gh-claude/commit/4c988a600cc2bfa50a0b6a8c887ba65ce16f2a2d))
* add gh ai run explain command for GitHub Actions diagnostics ([4262832](https://github.com/gh-extensions/gh-claude/commit/42628328bbbd62d5f9e8859aa862dcaa500614be)), closes [#5](https://github.com/gh-extensions/gh-claude/issues/5)
* add git branch verification guidance to chat templates ([2c4a8a0](https://github.com/gh-extensions/gh-claude/commit/2c4a8a0691be81e1fcfc5884fda1a54906f50b83))
* add GitHub issue URL support to issue commands ([38c83d9](https://github.com/gh-extensions/gh-claude/commit/38c83d9ae41625a431207ef5d25b999f4940204f)), closes [#68](https://github.com/gh-extensions/gh-claude/issues/68)
* add GitHub PR URL support to pr commands ([8692cc8](https://github.com/gh-extensions/gh-claude/commit/8692cc81b76fa3a3f3b0c10cc73a3e6b82ecd5f1))
* add issue templates for github workflow ([7d66321](https://github.com/gh-extensions/gh-claude/commit/7d6632133d06daad8a7de57aac916f8699654273))
* add jq dependency and version command ([692e430](https://github.com/gh-extensions/gh-claude/commit/692e43095cff5aa9162236cbd147c0d630ee02c9))
* add logging for agent session lifecycle events ([de51d9a](https://github.com/gh-extensions/gh-claude/commit/de51d9ae3b22700085d494869801c1418ab01ba8))
* add optional description flag to issue plan command ([cbfa693](https://github.com/gh-extensions/gh-claude/commit/cbfa693309ea5be0493ffc13554df9c18144fad9))
* add persistent session management for chat commands ([0814548](https://github.com/gh-extensions/gh-claude/commit/08145486e55437d07ff79da37336c06b0506ed6d))
* add safe worktree removal with auto-stash and unpushed warnings ([7d20549](https://github.com/gh-extensions/gh-claude/commit/7d205490b2bcf6f9d1c6dc9d7910e12b3b735e2f))
* add slash command skills, reorganize plugin structure, and fix awk compat ([4c4abc3](https://github.com/gh-extensions/gh-claude/commit/4c4abc3d72a0d84240ab0cd5a00010bb208b897a))
* add zsh plugin entry point for plugin manager support ([9dada57](https://github.com/gh-extensions/gh-claude/commit/9dada57de2eaef84bcc99221538511cb9811f32b))
* append markdownlint-disable directive to AI-generated bodies ([2b6207e](https://github.com/gh-extensions/gh-claude/commit/2b6207ec52e9676cd8c73d8f58cd14ae70f080cb))
* capture current branch in pr and run chat templates ([edcdb83](https://github.com/gh-extensions/gh-claude/commit/edcdb831850d01752f8b89ec06c443478a6bf48b))
* **cli:** add --yes flag for non-interactive PR workflow ([5343878](https://github.com/gh-extensions/gh-claude/commit/53438788fc5acb9bc31110ea3359823bbae80a17))
* **cli:** add case-insensitive prompt matching ([346adc6](https://github.com/gh-extensions/gh-claude/commit/346adc6b5ee432a8365be5d7506bf77d70931bcc))
* **cli:** add gh-agent extension with commit message generation ([2059016](https://github.com/gh-extensions/gh-claude/commit/20590167ba8a84a8236eb368e32249a6da18fa6d))
* **cli:** add install command for configuration files ([e15983a](https://github.com/gh-extensions/gh-claude/commit/e15983afcd6c5edd894cbc28d9fc0933de126703))
* **cli:** add issue task management to gh assistant ([bf70a72](https://github.com/gh-extensions/gh-claude/commit/bf70a72253ab075963b78f7c9c4d2db5d476491b))
* enforce gh-worktree branching rules in chat templates ([f39d4e3](https://github.com/gh-extensions/gh-claude/commit/f39d4e3ad66dd6f959b4f09dca34086977cfd8c8))
* **extras:** add gh-fzf keybindings for gh-ai integration ([16febbf](https://github.com/gh-extensions/gh-claude/commit/16febbf893ceab45f8130993998bf514ef424ec5))
* **gh-pr-review:** warn on duplicate review for same commit ([72e4e5c](https://github.com/gh-extensions/gh-claude/commit/72e4e5ca19a39aafa7f0dc1293ff25edacf67149))
* include PR and issue URLs in templates ([a80e51a](https://github.com/gh-extensions/gh-claude/commit/a80e51a9ce6fa3fd557515cd3a961e7b2b9cdae0)), closes [#55](https://github.com/gh-extensions/gh-claude/issues/55)
* **install:** add force flag to cp commands ([83ad5b7](https://github.com/gh-extensions/gh-claude/commit/83ad5b7b9c029ac20d6b8b4ebb54e43308b601c4))
* make gum an optional dependency ([a82111d](https://github.com/gh-extensions/gh-claude/commit/a82111d573fb9cc231a7e159d917d767422f43fa))
* open chat bindings in tmux window for interactive fzf ([38c68f6](https://github.com/gh-extensions/gh-claude/commit/38c68f6e0f1da61c0fc5ec124f1c1425de037079))
* overhaul session management, worktree lifecycle, and context pipeline ([7155434](https://github.com/gh-extensions/gh-claude/commit/715543482f826533058420c57608012b45c4659c))
* pin run chat sessions to exact commit that triggered failure ([a57c392](https://github.com/gh-extensions/gh-claude/commit/a57c392ef4c9290e5b7858f6705a31f6da6b38fd))
* pre-trust project directory to skip Claude trust dialog ([4d7079b](https://github.com/gh-extensions/gh-claude/commit/4d7079b18eff3980ae13e49af080dd594b18e35e))
* remove tmux terminal title setting from chat commands ([2599cc2](https://github.com/gh-extensions/gh-claude/commit/2599cc2b3597ed1fcda44d625983a0e609a20450))
* remove worktree lifecycle from gh-ai ([7fd754d](https://github.com/gh-extensions/gh-claude/commit/7fd754d0755a0783cb5e55a6762e0b6425280804))
...
* replace issue develop with plan command that prints to stdout ([936233e](https://github.com/gh-extensions/gh-claude/commit/936233e6bba929cb22e4441e10388acf834c64f2))
* set terminal title when starting a chat session ([09ba6d4](https://github.com/gh-extensions/gh-claude/commit/09ba6d46d2284cfd59547c80543a8b0144f00d51))
* skip worktree lifecycle when running inside an existing worktree ([93976ee](https://github.com/gh-extensions/gh-claude/commit/93976eeea8718d9828ce1433ef6ba3bceede3e7e))
* store sessions in .github/sessions instead of .claude/sessions ([bf3cccf](https://github.com/gh-extensions/gh-claude/commit/bf3cccf413495fc4ea261424814a67f94082d5b8))
* store sessions in current worktree instead of main worktree ([85fcd3c](https://github.com/gh-extensions/gh-claude/commit/85fcd3c5de8cb959b692eaebcf656afe0461bb13))
* strip leading # from issue and PR numbers in argument parsing ([2489b88](https://github.com/gh-extensions/gh-claude/commit/2489b887b50f0380ad79ab9a64e55ff644c0dc2e))
* update commit template to include optional description context ([340eb0f](https://github.com/gh-extensions/gh-claude/commit/340eb0ffd4073f8463e96bdd441f81163e2ff6d0))
* use file-backed variables to bypass ARG_MAX limits ([b5f0c8d](https://github.com/gh-extensions/gh-claude/commit/b5f0c8df73bd39da5757fb6fce60e588df394f56))
* warn when skipping worktree setup inside an existing worktree ([d6a8752](https://github.com/gh-extensions/gh-claude/commit/d6a87524a71bd78f41c413cea8e800b0f4743f85))


### Bug Fixes

* add _gh_session_base_dir to declare -f lists in chat test setups ([74eb3f2](https://github.com/gh-extensions/gh-claude/commit/74eb3f2e8ec27f619e16f8b5ff3082c18a396d7d))
* add _git_main_worktree_path and --git-common-dir mock to chat test setups ([c0881b1](https://github.com/gh-extensions/gh-claude/commit/c0881b11b25546e7440611e2b1a13e85ecb686c5))
* add -- sentinel to gum log error calls in arg parsers ([c9b043f](https://github.com/gh-extensions/gh-claude/commit/c9b043fdb912d00b0d55b9a56ed5a2c6d6e5593a))
* add +abort to terminal action bindings in gh_fzf.sh ([b7f3516](https://github.com/gh-extensions/gh-claude/commit/b7f3516c04994e96ccb9c0a3745c0f86f058c88c))
* add rev-parse --git-common-dir to _setup_chat_mocks git mock in gh_pr_chat.bats ([04f6816](https://github.com/gh-extensions/gh-claude/commit/04f6816adb4bc9369ec5be1b778ae37cdfcc5e58))
* add validation for required argument values in option parsing ([0fbec1d](https://github.com/gh-extensions/gh-claude/commit/0fbec1d7bf4719fd91ec982d2fc9c1fdb47de4b4))
* add validation for required variables in gh_pr and gh_run scripts ([b2a2fc4](https://github.com/gh-extensions/gh-claude/commit/b2a2fc46e00f4777a56fbd72933cba3f30afb316))
* add warning logs when --from-pr flag is used in chat ([c730bec](https://github.com/gh-extensions/gh-claude/commit/c730bec74eb9a213d481e0004886bc19464ef048))
* address deep review findings in gh_worktree.sh ([75d3c97](https://github.com/gh-extensions/gh-claude/commit/75d3c97627adf9f226cd24224ff2584ddec426b8))
* address review findings in --checkout implementation ([1e7e1a1](https://github.com/gh-extensions/gh-claude/commit/1e7e1a1c658edf1ea84235b8a27c7cdb42058c27))
* **cli:** adjust PR task list filter parameter ([957ec5d](https://github.com/gh-extensions/gh-claude/commit/957ec5daf46c84efdf65b5204fae6a1483979c6e))
* **cli:** adjust PR task list filter regex ([1b7f234](https://github.com/gh-extensions/gh-claude/commit/1b7f234e53ec0debfe559829b8ad12d717082037))
* **cli:** improve temporary file path handling ([432f291](https://github.com/gh-extensions/gh-claude/commit/432f2911a691a700c9485b2c8ff80b4d6993ad41))
* **cli:** remove commented trap command ([ec214f3](https://github.com/gh-extensions/gh-claude/commit/ec214f315e4cc390e9a5e9cc459b769c6b48c4f2))
* **cli:** remove regex filter from PR task list command ([6eb0d5c](https://github.com/gh-extensions/gh-claude/commit/6eb0d5c7588bc31e24cc5f5208dcc0695f85af7f))
* **cli:** remove unnecessary backslash in gh api commands ([ccc216a](https://github.com/gh-extensions/gh-claude/commit/ccc216a58ed4f672ee549374f87bb9d325abbf7a))
* configure git identity in gh_worktree.bats setup for CI compatibility ([f81eb74](https://github.com/gh-extensions/gh-claude/commit/f81eb744c3cc87e5771bf3937d02a11508f61d2e))
* drop worktree- prefix from local branch names ([2579e51](https://github.com/gh-extensions/gh-claude/commit/2579e5190efb23ece5a0eb7a35b00687c7fb732c))
* ensure preamble has trailing newlines before passing to claude ([cc9081e](https://github.com/gh-extensions/gh-claude/commit/cc9081e6a273fe2658e13615fe147e19b99bdd02))
* **extras:** preserve existing GH_FZF_*_OPTS environment variables ([5def927](https://github.com/gh-extensions/gh-claude/commit/5def92721ec3f79f70e44fe54de1c097692370b7))
* **extras:** prevent tmux from renaming chat windows ([9d0cd1b](https://github.com/gh-extensions/gh-claude/commit/9d0cd1b6e52ff4f2c4b7882659d2acdec518ef62))
* fetch remote branch before creating worktree ([f48f437](https://github.com/gh-extensions/gh-claude/commit/f48f4376bbc070965d66373a3102a96704af8a5e))
* filter out --from-pr flag in _cmd_chat to prevent conflicts ([5dcea3f](https://github.com/gh-extensions/gh-claude/commit/5dcea3fe208a02a904a621616182cee20436fff7))
* **gh-issue-plan:** fix marker lookup and PATCH body encoding ([3d3b83e](https://github.com/gh-extensions/gh-claude/commit/3d3b83e739e3b45c39d29922d04f116b6adfa57a))
* **gh-issue-plan:** use $GH_AI_ISSUE_NUMBER in API URL path ([7204873](https://github.com/gh-extensions/gh-claude/commit/72048739f90f5843e5e33ae3cda2b19d216b7455))
* **gh-pr-review:** fix awk parsing, add paginated review history, clarify inline comments ([5404905](https://github.com/gh-extensions/gh-claude/commit/5404905aedab192e41b3dcd996333272bb0d8b76))
* **gh-pr-review:** save pr_diff.patch to state/ dir ([ef7eede](https://github.com/gh-extensions/gh-claude/commit/ef7eede5de3c6eadb5d8ae8c28e865885d09bcff))
* improve fzf keybinding mnemonics ([80d9e9d](https://github.com/gh-extensions/gh-claude/commit/80d9e9d5376f0a79278718af323986685e29d377))
* improve git default branch detection in worktree script ([45ab003](https://github.com/gh-extensions/gh-claude/commit/45ab003a5e4c167f6ce29b00d1054572320fbed0))
* normalize routing error casing to lowercase ([34ad1f1](https://github.com/gh-extensions/gh-claude/commit/34ad1f158d398c4881db222b84e3afb9ba27a5c8))
* preserve flag values when filtering issue create args ([f3cca86](https://github.com/gh-extensions/gh-claude/commit/f3cca86d091b0db548f2e05b2c7735df8ac5d81e))
* remove --comment flag from gh_pr_review filter ([7746d5e](https://github.com/gh-extensions/gh-claude/commit/7746d5e95a9f6aabd151c568771b1aa958ab086f))
* remove dead _show_issue_create_help and fix stale comments ([766950e](https://github.com/gh-extensions/gh-claude/commit/766950e82a78ea7f2239dbfff7cdbdf164b95b90))
* remove noisy warn log when running inside a worktree ([3ef835f](https://github.com/gh-extensions/gh-claude/commit/3ef835f1c10618313677f320cbe6e49665b02835))
* remove PR number from clean_args in gh_pr_review ([2788bb4](https://github.com/gh-extensions/gh-claude/commit/2788bb48b290e98ba97e9c4fabffe01690360aff))
* replace cat with jq to avoid WorktreeCreate hook deadlock ([5a8e622](https://github.com/gh-extensions/gh-claude/commit/5a8e6220a58afd59d7cb296d4f11acca1b94d53b))
* resolve gh_render.awk path using BASH_SOURCE instead of _gh_ai_source_dir ([690acdc](https://github.com/gh-extensions/gh-claude/commit/690acdcf4e2ad59618ea7341725248019c053d03))
* resolve gh_tmux.sh path as absolute in both bash and zsh ([b276b77](https://github.com/gh-extensions/gh-claude/commit/b276b77a67db2262955cea105a28b20d5abd4219))
* resolve nameref conflict and set -e leak in tests ([ad72e4e](https://github.com/gh-extensions/gh-claude/commit/ad72e4e0184f3cd50c65f460ee559fddfdacffad))
* resolve sessions from main worktree root ([39a2c97](https://github.com/gh-extensions/gh-claude/commit/39a2c9739a05c5733dde1199057dc06f93377111))
* reuse existing worktree in WorktreeCreate hook ([a9d01a4](https://github.com/gh-extensions/gh-claude/commit/a9d01a4ca313a6298ec4db7681384a21fd9c5cc9))
* **run:** include workflow run id in spinner messages ([0038fcc](https://github.com/gh-extensions/gh-claude/commit/0038fcc9c722ff93c220a3d4132b6853af9ab1de))
* serialize GH_FZF_*_OPTS with printf %q for eval-safe format ([fb6572a](https://github.com/gh-extensions/gh-claude/commit/fb6572af47be34b21dc4de690d03cec25bb07e6b))
* set upstream tracking on newly created worktree branches ([4886d3f](https://github.com/gh-extensions/gh-claude/commit/4886d3f497fa15adee108e00a5cc23b8002b5c46))
* **skills:** address all skill reviewer findings ([0e8ca5b](https://github.com/gh-extensions/gh-claude/commit/0e8ca5ba53c064651fb309e4a963eb85731e30f5))
* **skills:** fix marker placeholder and paginated review parsing ([c22d7e2](https://github.com/gh-extensions/gh-claude/commit/c22d7e245caac46c8b2fa4bfa4d998bcbd35622d))
* **skills:** guarantee marker expansion and guard against empty env vars ([a4df4cb](https://github.com/gh-extensions/gh-claude/commit/a4df4cb7f5f2ebdc199e6eb359e1c0d312d77a75))
* **skills:** strip trailing newline from title draft files ([8002f3d](https://github.com/gh-extensions/gh-claude/commit/8002f3d1c1783cb152338c4f62788d1b7a778b53))
* squeeze blank lines in preamble before passing to agent ([01a138b](https://github.com/gh-extensions/gh-claude/commit/01a138b9db8c70ea1a5a3574d223f5d458eb86d6))
* steer gh ai pr comment toward conversational output ([962429b](https://github.com/gh-extensions/gh-claude/commit/962429b12f443a23f519b6f18d4e333cd21de4cf))
* **tests:** export _gum and _has_gum in BATS setup functions ([61abf03](https://github.com/gh-extensions/gh-claude/commit/61abf03d132c4400858dcf6cbf52e8fb457619c1))
* update test mocks to include url field in gh issue/pr view responses ([ad32dbc](https://github.com/gh-extensions/gh-claude/commit/ad32dbc41d89d033642a9316c981d5b1dc0fa345))
* use actual default branch in worktree tests ([2067972](https://github.com/gh-extensions/gh-claude/commit/206797212e3901351338faff9fb1a5843ac6ac27))
* use dynamic default branch in gh_worktree.bats setup() ([911d723](https://github.com/gh-extensions/gh-claude/commit/911d72326b569549e3fa553ff61f8c31051d0948))
* use git apply instead of gh pr diff for statistics ([5b22327](https://github.com/gh-extensions/gh-claude/commit/5b22327285942f2c00f3c3f89f6de3890df5197a))
* use pipe-based file reading in awk to prevent hangs ([5364539](https://github.com/gh-extensions/gh-claude/commit/53645392c165c762c2cf74e49874f7468fabfab6))
* use printf -v to set preamble variable directly ([0705be9](https://github.com/gh-extensions/gh-claude/commit/0705be9e610ae81079d6e16df3231ea860492e24))
* use URL-derived worktree name for run chat sessions ([972e7d4](https://github.com/gh-extensions/gh-claude/commit/972e7d44a4c04edc12b8e7d83ca74078e2f66227))
* wrap GH_PR_DESCRIPTION in &lt;description&gt; tag in pr create template ([faef97e](https://github.com/gh-extensions/gh-claude/commit/faef97e0f951fe80f5b83f360021550083037cf6))


### Performance Improvements

* **run:** truncate workflow logs to prevent ARG_MAX overflow ([6ec04a3](https://github.com/gh-extensions/gh-claude/commit/6ec04a3633d864dde53e9735514f266435e49980))


### Reverts

* remove git branch verification from chat templates ([fb0d26b](https://github.com/gh-extensions/gh-claude/commit/fb0d26b31929d69a2d527dd3b0cfb6825b454cf2))

## [0.22.0](https://github.com/gh-extensions/gh-claude/compare/v0.21.0...v0.22.0) (2026-03-18)
